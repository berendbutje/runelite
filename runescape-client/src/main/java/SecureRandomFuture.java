...
public class SecureRandomFuture {
	...
	static void getLoginError(int var0) {
		if (var0 == -3) { // L: 3071
			...
			Login.setLoginIndex(3); // L: 3075
			Login.Login_accountLoggedInResponse = 1; // L: 3076
		} else if (var0 == 4) { // L: 3078
			Login.setLoginIndex(14); // L: 3080
			Login.Login_accountBlockedResponse = 0; // L: 3081
		} else if (var0 == 5) { // L: 3084
			Login.Login_accountLoggedInResponse = 2; // L: 3085
			...
			if (var0 == 7) { // L: 3091
				...
				Login.setLoginIndex(14); // L: 3103
				Login.Login_accountBlockedResponse = 1; // L: 3104
				...
				if (var0 == 61) { // L: 3132
					Login.setLoginIndex(7); // L: 3133
				} else {
					if (var0 == 62) { // L: 3135
						WorldMapData_1.updateGameState(10); // L: 3136
						Login.setLoginIndex(9); // L: 3137
